...
<form action="/secure/threadView/createThead" method="POST" role="form">
    <div class="form-group">
        <label for="threadName">Thread Name:</label>
        <input type="text" class="form-control" id="threadName" name="threadName" value="<c:out value="${threadView.threadName}"/>">
    </div>
    <div class="form-group">
        <label for="threadDescription">Thread Description:</label>
        <textarea class="form-control" rows="2" id="threadDescription" name="threadDescription"value="<c:out value="${theadView.threadDescription}"/>"></textarea>
    </div>
